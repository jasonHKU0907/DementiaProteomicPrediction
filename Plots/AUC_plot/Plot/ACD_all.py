...
titlename = 'All incident ACD'
dpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Results/'
output_img = dpath + 'Plots/Figure3/Plot/ALL_ACD.png'


mydf = pd.read_csv(dpath + 'Plots/Figure3/Data/ACD_ALL.csv')
...
legend1 = 'Plasma GFAP only (AUC =' +                   str(auc_mean_m`) +')'
