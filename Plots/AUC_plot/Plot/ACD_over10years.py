...
titlename = 'Over 10 years incident ACD'
dpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Results/'
output_img = dpath + 'Plots/Figure3/Plot/Over10YEARS_ACD.png'


mydf = pd.read_csv(dpath + 'Plots/Figure3/Data/ACD_OVER10YEARS.csv')
