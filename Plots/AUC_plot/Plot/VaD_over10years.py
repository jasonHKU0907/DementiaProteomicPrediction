...
titlename = 'Over 10 years incident VaD'
dpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Results/'
output_img = dpath + 'Plots/Figure3/Plot/Over10YEARS_VaD.png'


mydf = pd.read_csv(dpath + 'Plots/Figure3/Data/VaD_OVER10YEARS.csv')
...
legend2 = 'GDF15 + demographic  (' +                     str(auc_mean_m2) +')'
legend3 = 'GDF15 + demographic + cognition (' +          str(auc_mean_m3) +')'
