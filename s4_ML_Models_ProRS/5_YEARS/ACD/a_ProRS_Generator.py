...
outputfile = outpath + 'ML_Modeling_ProRS/5_YEARS/ACD/ProRS_Data.csv'
...
for fold_id in fold_id_lst:
    ...
    prors_df.to_csv(outpath + 'ML_Modeling_ProRS/5_YEARS/ACD/ProRS/Test_fold' + str(fold_id) + '.csv', index = False)
