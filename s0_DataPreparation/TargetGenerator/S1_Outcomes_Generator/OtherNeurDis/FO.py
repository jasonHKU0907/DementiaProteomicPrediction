...
target_date_f = [str(i) + '-0.0' for i in range(131012, 131035) if i%2==0] + [str(i) + '-0.0' for i in range(131038, 131041) if i%2==0]
...
target_df_out.to_csv(outpath + 'ONeurD_FO.csv', index = False)
