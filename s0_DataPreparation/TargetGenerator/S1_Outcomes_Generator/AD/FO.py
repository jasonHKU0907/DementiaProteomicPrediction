...
outpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Data/TargetOutcomes/AD/'
...
target_date_f = ['131036-0.0', '130836-0.0']
target_source_f = ['131037-0.0', '130837-0.0']
...
target_df_out.to_csv(outpath + 'AD_FO.csv', index = False)
