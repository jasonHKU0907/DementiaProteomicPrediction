...
target_date_f = [str(i) + '-0.0' for i in range(130992, 131011) if i%2==0] + [str(i) + '-0.0' for i in range(131042, 131127) if i%2==0]
...
target_df_out.to_csv(outpath + 'ONervD_FO.csv', index = False)
