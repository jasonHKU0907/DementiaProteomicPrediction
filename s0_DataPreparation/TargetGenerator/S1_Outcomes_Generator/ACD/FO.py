...
outpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Data/TargetOutcomes/ACD/'
...
target_date_f = [str(i) + '-0.0' for i in range(130836, 130843) if i%2==0] + ['131036-0.0']
target_date_f = fo_f
...
target_df_out.to_csv(outpath + 'ACD_FO.csv', index = False)
