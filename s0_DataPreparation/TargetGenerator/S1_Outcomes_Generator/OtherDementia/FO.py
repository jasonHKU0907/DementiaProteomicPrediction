...
outpath = '/Volumes/JasonWork/Projects/AD_Proteomics/Data/TargetOutcomes/OtherDementia/'
...
target_date_f = ['130840-0.0']
target_source_f = ['130841-0.0']
...
target_df_out.to_csv(outpath + 'OD_FO.csv', index = False)
