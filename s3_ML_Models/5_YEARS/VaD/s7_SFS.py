...
outfile = outpath + 'ML_Modeling/5_YEARS/VaD/s7_SeqSelector.csv'

pro_f_df = pd.read_csv(outpath + 'ML/5_YEARS/VaD/AccAUC_TotalGain.csv')
...
f_rank_df = pd.read_csv(outpath + 'ML_Modeling/5_YEARS/VaD/s6_FeaImpRank.csv')
