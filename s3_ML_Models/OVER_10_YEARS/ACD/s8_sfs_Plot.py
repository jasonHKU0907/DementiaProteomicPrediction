...
output_img_dir = dpath + 'ML_Modeling/OVER_10_YEARS/ACD/s8_plot.png'

pro_imp_df = pd.read_csv(dpath + 'ML_Modeling/OVER_10_YEARS/ACD/s6_FeaImpRank.csv')
pro_imp_df.rename(columns = {'TotalGain_cv': 'Pro_imp'}, inplace = True)
pro_auc_df = pd.read_csv(dpath + 'ML_Modeling/OVER_10_YEARS/ACD/s7_SeqSelector.csv')
