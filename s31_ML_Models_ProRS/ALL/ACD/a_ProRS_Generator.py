...
outputfile = outpath + 'ML_Modeling_ProRS/ALL/ACD/ProRS_Data.csv'

pro_f_df = pd.read_csv(outpath + 'ML/ALL/ACD/AccAUC_TotalGain.csv')
...
for fold_id in fold_id_lst:
    ...
    prors_df.to_csv(outpath + 'ML_Modeling_ProRS/ALL/ACD/ProRS/Test_fold' + str(fold_id) + '.csv', index = False)
